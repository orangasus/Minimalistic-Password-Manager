# Classes responsible for login
# and creating user procedures
...
class LoginIntoAppFrame(StandardFrame):
    def __init__(self, parent, controller):
        ...
        self.description_label = ctk.CTkLabel(self, text='Welcome to Minimalistic Password Manager!',
                                              font=app_style.FONT_PRESET_MAIN,
                                              text_color=app_style.ACCENT_COLOR)
        self.login_entry = EntryWithPlaceholder(self, self.str_var_user_login, 'Login')
    ...
    def fill_window_layout(self):
        self.description_label.grid(row=1, column=0, columnspan=2, sticky='s', pady=10)
        self.login_entry.grid(row=2, column=0, columnspan=2, sticky='s', pady=2)
        self.password_entry.grid(row=3, column=0, columnspan=2, sticky='n', pady=2)
        self.login_button.grid(row=4, column=0, sticky='ne', pady=10, padx=20)
        self.create_user_button.grid(row=4, column=1, sticky='nw', pady=10, padx=20)
...
class CreateUserFrame(StandardFrame):
    def __init__(self, parent, controller):
        ...
        self.description_label = ctk.CTkLabel(self, text='Let\'s create you an account!',
                                              font=app_style.FONT_PRESET_MAIN,
                                              text_color=app_style.ACCENT_COLOR)
    ...
    def fill_window_layout(self):
        ...
        self.login_entry.grid(row=2, column=0, columnspan=2, pady=2)
        self.password_entry.grid(row=3, column=0, columnspan=2, pady=2)
        self.back_button.grid(row=4, column=0, pady=10, sticky='e', padx=20)
        self.create_button.grid(row=4, column=1, pady=10, sticky='w', padx=20)
